    ...
    public partial class BarangMasuk : Form
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString(
                "No. Transaksi : " + guna2CmbTransaksi.Text,
                font, Brushes.Black, 20, y);
            y += 25;

            e.Graphics.DrawString(
                "Tanggal       : " + guna2dtTanggal.Text,
                font, Brushes.Black, 20, y);
            y += 25;

            e.Graphics.DrawString(
                "Kasir         : " + guna2TxtKasir.Text,
                font, Brushes.Black, 20, y);
            y += 30;
            ...
            foreach (DataGridViewRow baris in dataGridView1.Rows)
            {
                ...
                e.Graphics.DrawString(
                    ...
                    font, Brushes.Black, 150, y);

                e.Graphics.DrawString(
                    baris.Cells[3].Value.ToString(),
                    font, Brushes.Black, 230, y);

                e.Graphics.DrawString(
                    baris.Cells[4].Value.ToString(),
                    font, Brushes.Black, 280, y);
            ...
            e.Graphics.DrawString(
                "Total      : " + guna2TxtTotal.Text,
                bold, Brushes.Black, 20, y);
            y += 25;

            e.Graphics.DrawString(
                "Bayar      : " + guna2TxtBayar.Text,
                font, Brushes.Black, 20, y);
            y += 25;

            e.Graphics.DrawString(
                "Kembalian  : " + guna2TxtKembali.Text,
                font, Brushes.Black, 20, y);
            y += 40;

            e.Graphics.DrawString(
                "Terima kasih telah berbelanja!",
                font, Brushes.Black, 70, y);
        }
    }
}

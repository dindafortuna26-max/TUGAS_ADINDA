...
namespace adindaa1
{
    public partial class KategoriUser : Form
    {
        public KategoriUser()
        {
            InitializeComponent();
        ...
        private void guna2TxtCariKategori_TextChanged(object sender, EventArgs e)
        {
            ...
            string cari = guna2TxtCariKategori.Text;

            db.crud(
                "SELECT b.nama_barang, b.harga_jual, k.nama_kategori, b.stok " +
                "FROM tbarang b " +
                "JOIN tkategori k ON b.id_kategori = k.id_kategori " +
                $"WHERE k.nama_kategori LIKE '%{cari}%'"
            );
        ...
        private void guna2TxtNamaBarang_TextChanged(object sender, EventArgs e)
        {
